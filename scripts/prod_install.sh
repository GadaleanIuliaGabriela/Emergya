...
if [[ "${SITE_INSTALL}" == "1" ]]; then
  ...
  drush cset -y system.site uuid "29ad5c9a-0f76-4799-b8ac-5cd09c743191"
  drush entity:delete -y shortcut_set
  drush cset -y language.entity.en uuid "b6f99eeb-3ec8-4f40-a067-91f03e03d42b"
